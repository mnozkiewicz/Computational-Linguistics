...
| **Lab 3** |  Fine-tuning | Built two sentiment classification models: a fine-tuned \texttt{bert-base-uncased} model and a compact transformer trained entirely from scratch. Compared training efficiency and classification performance. |
